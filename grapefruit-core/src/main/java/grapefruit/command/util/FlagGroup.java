 ...
 */
public class FlagGroup implements Iterable<BoundArgument.Flag<?>> {
    private final List<BoundArgument.Flag<?>> arguments;

    private FlagGroup(List<BoundArgument.Flag<?>> arguments) {
     ...
     */
    public static Optional<FlagGroup> attemptParse(String input, List<BoundArgument.Flag<?>> candidates) throws CommandException {
        /*
    ...
    /**
     * Selects a single {@link BoundArgument.Flag} from the provided list of
     ...
     */
    private static BoundArgument.Flag<?> selectFlag(
            List<BoundArgument.Flag<?>> candidates,
            Predicate<FlagArgument<?>> test,
            Supplier<CommandException> exceptionFactory
    ) throws CommandException {
        return candidates.stream().filter(x -> test.test(x.argument()))
                .findFirst()
    ...
    @Override
    public @NotNull Iterator<BoundArgument.Flag<?>> iterator() {
