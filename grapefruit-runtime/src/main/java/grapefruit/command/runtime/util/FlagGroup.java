 ...
 */
public class FlagGroup implements Iterable<CommandArgument.Flag<?>> {
    private final List<CommandArgument.Flag<?>> arguments;

    private FlagGroup(List<CommandArgument.Flag<?>> arguments) {
     ...
     */
    public static Optional<FlagGroup> attemptParse(String input, List<CommandArgument.Flag<?>> candidates) throws CommandException {
        /*
    ...
    /**
     * Selects a single {@link CommandArgument.Flag} from the provided list of
     ...
     */
    private static CommandArgument.Flag<?> selectFlag(
            List<CommandArgument.Flag<?>> candidates,
    ...
    @Override
    public @NotNull Iterator<CommandArgument.Flag<?>> iterator() {
