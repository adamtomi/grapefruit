...
@Deprecated
public class StandardParameter0<S> implements ParameterNode0<S> {
    private final String name;
    private final ParameterMapper<S, ?> mapper;
    private final CommandParameter0 param;

    public StandardParameter0(final @NotNull String name,
    ...
    @Override
    public @NotNull CommandParameter0 unwrap() {
        return this.param;
    }
    ...
    public boolean equals(final @Nullable Object o) {
        ...
        final StandardParameter0<?> that = (StandardParameter0<?>) o;
    ...
    public static final class PresenceFlag<S> extends StandardParameter0<S> {
    ...
    public static final class ValueFlag<S> extends StandardParameter0<S> {
